...
const text = {
  en: {
    ...
    projectsTitle: "Project environments where reliability, presentation and engineering coordination work together.",
  ...
  ar: {
    ...
    projectsTitle: "بيئات مشاريع تجمع بين الاعتمادية والمظهر الاحترافي والتنسيق الهندسي.",
