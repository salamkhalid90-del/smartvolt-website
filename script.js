...
const text = {
  en: {
    ...
    introRemoteTitle: "Management from anywhere in the world",
    introRemoteText: "Remote monitoring, scene control and technical supervision through secure smart building interfaces.",
    ...
    automationTitle: "KNX, sensors and field-device integration",
  ...
  ar: {
    ...
    introRemoteTitle: "إدارة من أي مكان في العالم",
    introRemoteText: "مراقبة وتشغيل المشاهد والإشراف الفني عن بعد عبر واجهات سمارت آمنة ومصممة للمباني الحديثة.",
    ...
    automation: "أتمتة",
    automationTitle: "تكامل KNX والحساسات والأجهزة الميدانية",
...
const bindings = [
  ...
  [".intro-collage figcaption strong", "introRemoteTitle"],
  [".intro-collage figcaption span", "introRemoteText"],
