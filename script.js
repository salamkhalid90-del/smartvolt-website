...
const text = {
  en: {
    ...
    projectsTitle: "Project environments where reliability and presentation both matter.",
    ...
    servicesTitle: "Engineering services for intelligent power and building automation.",
    ...
    productsTitle: "Selected product categories for engineered smart buildings.",
    product1Title: "KNX Devices",
    product1Text: "Actuators, sensors, keypads, couplers, power supplies and visualization servers.",
    product2Title: "Building Management",
    product2Text: "Supervisory controls, dashboards, meters, gateways and integration controllers.",
    product3Title: "Electrical Distribution",
    product3Text: "Switchgear components, breakers, contactors, meters, relays and protection devices.",
    product4Title: "Low Current Systems",
    product4Text: "CCTV, access control, intercom, structured cabling and security integration.",
    partnersEyebrow: "Technology partners",
    partnersTitle: "Trusted brands and systems we integrate in professional projects.",
    ...
    panelsTitle: "Designed, assembled and documented for dependable operation.",
    ...
    consultationTitle: "Get clarity before procurement, installation or tender submission.",
    ...
    trustTitle: "Planning first, clear decisions, and execution the client can understand.",
  ...
  ar: {
    ...
    projectsTitle: "بيئات مشاريع تحتاج إلى الاعتمادية والمظهر الاحترافي معاً.",
    ...
    servicesTitle: "خدمات هندسية للطاقة الذكية وأتمتة المباني.",
    ...
    productsTitle: "فئات منتجات مختارة للمباني الذكية المصممة هندسياً.",
    product1Title: "أجهزة KNX",
    product1Text: "مشغلات، حساسات، مفاتيح، كوابلر، مزودات طاقة وسيرفرات عرض وتحكم.",
    product2Title: "إدارة المباني",
    product2Text: "أنظمة إشراف، لوحات متابعة، عدادات، بوابات تكامل ومتحكمات.",
    product3Title: "التوزيع الكهربائي",
    product3Text: "قواطع، كونتاكتورات، عدادات، ريليات وحمايات كهربائية.",
    product4Title: "أنظمة التيار الخفيف",
    product4Text: "كاميرات مراقبة، دخول ذكي، انتركوم، شبكات وتكامل أنظمة الأمن.",
    partnersEyebrow: "شركات وتقنيات",
    partnersTitle: "علامات وأنظمة موثوقة ندمجها في المشاريع الاحترافية.",
    ...
    panelsTitle: "تصميم وتجميع وتوثيق لضمان تشغيل يعتمد عليه.",
    ...
    consultationTitle: "وضوح فني قبل الشراء أو التنفيذ أو تقديم العطاء.",
    ...
    trustTitle: "نبدأ بالتخطيط والدراسة حتى يعرف المستفيد ما سيحدث على أرض الواقع.",
...
const bindings = [
  ...
  [".nav-links a[href='#products']", "navProducts"],
  ...
  [".hero-actions .ghost", "viewPortfolio"],
  ...
  [".product-grid article:nth-child(1) h3", "product1Title"],
  [".product-grid article:nth-child(1) p", "product1Text"],
  [".product-grid article:nth-child(2) h3", "product2Title"],
  [".product-grid article:nth-child(2) p", "product2Text"],
  [".product-grid article:nth-child(3) h3", "product3Title"],
  [".product-grid article:nth-child(3) p", "product3Text"],
  [".product-grid article:nth-child(4) h3", "product4Title"],
  [".product-grid article:nth-child(4) p", "product4Text"],
